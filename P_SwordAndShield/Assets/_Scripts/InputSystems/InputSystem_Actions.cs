...
//     version 1.11.1
//     from Assets/_Scripts/InputSystems/InputSystem_Actions.inputactions
//
...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Attack2"",
                    ""type"": ""Button"",
                    ""id"": ""e5833204-426e-4447-8f3d-3287dd8ab017"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""40fe4898-54be-474a-b48a-7d87e66b3559"",
    ...
    ""controlSchemes"": [
        ...
        m_GameStateActive_Attack2 = m_GameStateActive.FindAction("Attack2", throwIfNotFound: true);
        m_GameStateActive_Interact = m_GameStateActive.FindAction("Interact", throwIfNotFound: true);
        m_GameStateActive_Reload = m_GameStateActive.FindAction("Reload", throwIfNotFound: true);
        m_GameStateActive_Boost = m_GameStateActive.FindAction("Boost", throwIfNotFound: true);
    ...
    ~@InputSystem_Actions()
    {
        UnityEngine.Debug.Assert(!m_GameStateActive.enabled, "This will cause a leak and performance issues, InputSystem_Actions.GameStateActive.Disable() has not been called.");
    ...
    private readonly InputAction m_GameStateActive_Attack2;
    private readonly InputAction m_GameStateActive_Interact;
    private readonly InputAction m_GameStateActive_Reload;
    private readonly InputAction m_GameStateActive_Boost;
    ...
    public struct GameStateActiveActions
    {
        ...
        public InputAction @Attack2 => m_Wrapper.m_GameStateActive_Attack2;
        public InputAction @Interact => m_Wrapper.m_GameStateActive_Interact;
        public InputAction @Reload => m_Wrapper.m_GameStateActive_Reload;
        public InputAction @Boost => m_Wrapper.m_GameStateActive_Boost;
        ...
        public static implicit operator InputActionMap(GameStateActiveActions set) { return set.Get(); }
        public void AddCallbacks(IGameStateActiveActions instance)
        {
            if (instance == null || m_Wrapper.m_GameStateActiveActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_GameStateActiveActionsCallbackInterfaces.Add(instance);
        ...
        {
            if (m_Wrapper.m_GameStateActiveActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IGameStateActiveActions instance)
        {
            foreach (var item in m_Wrapper.m_GameStateActiveActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_GameStateActiveActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    public GameStateActiveActions @GameStateActive => new GameStateActiveActions(this);
